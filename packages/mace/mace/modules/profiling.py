"""
MACE Profiling Utilities

[PROFILING] This file is NEWLY ADDED for mlip-profiling project.
[PROFILING] Not part of the original MACE codebase.
...
Usage:
    from mace.modules.profiling import record_function_if_enabled, set_profiling_enabled
    
    # Enable profiling
    set_profiling_enabled(True)
    
    # Use in code
    with record_function_if_enabled("MACE::InteractionBlock"):
        # ... operations ...
"""
